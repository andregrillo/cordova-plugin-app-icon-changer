...
public class AppIconChanger extends CordovaPlugin {
    ...
    public void iconChangeDialog(String iconName) {
        ...
        TextView appIconText = (TextView) view.findViewById(appIconTextResId);
        ImageView appIcon = (ImageView) view.findViewById(appIconResId);
        Button appIconButton = (Button) view.findViewById(appIconButtonResId);
